...
const mockData: ReconciliationData | null = null;
...
export const ReconciliationView = () => {
  ...
  const isMatching = mockData ? mockData.totalSales === mockData.reportedCash : true;
    ...
    <Card className="p-8">
      ...
      {!mockData ? (
        <div className="text-center py-12">
          <p className="text-muted-foreground text-lg">No reconciliation data available.</p>
          <p className="text-sm text-muted-foreground mt-2">Sales data will appear here for daily reconciliation once transactions are recorded.</p>
        </div>
      ) : (
        <>
